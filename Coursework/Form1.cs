...
namespace Coursework
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            if (lbl_upgrades.Visible == true)
            {
                if (woodTotal >= woodUpgCost)
                {
                    btn_woodUpg1.Text = "+ 20% Efficiency: $" + woodUpgCost;
                    btn_woodUpg1.Visible = true;
                }
            }
            else
            {
                ...
                if (money >= woodUpgrade)
                {
                    if (woodUpgCount == 0)
                    {
                        woodUpgrade = 25;
                        woodUpgCount++;
                        woodCount = woodCount + woodCount * 0.4;
                    }
                    else
                    {
                    ...
                    woodMult = woodMult + (woodMult * 1.1);
                    woodLvl = woodLvl + 1;
